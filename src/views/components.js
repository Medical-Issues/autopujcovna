...
/**
 * Podmíněné zobrazení - renderuje první pravdivou větev
 */
export function cond(conditions) {
    for (const [condition, element] of conditions) {
        if (condition) {
...
/**
 * Fragment (kontejner bez vlastního elementu)
 */
...
export function icon(name, size = 20) {
    const icons = {
        ...
        login: `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>`,
        ...
        mapPin: `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>`,
